...
//	    }
	...
	public static List<String> GetQsList(String level, String[] domain) {
		...
		List<String> data = Arrays.asList("Tell me about Yourself?");
		return data;
	}
	...
	public static Map<String, Object> getInterviewFeedback(String text) {
		...
		// --- Strengths Section ---
		List<String> strengths = Arrays.asList("Good understanding of core Java and Spring Boot fundamentals.",
				"Confident communication and clear explanations.", "Quick in structuring answers logically.");
		...
		q1.put("feedback",
				"Good introduction, but try to keep it under 1 minute and highlight key achievements first.");
